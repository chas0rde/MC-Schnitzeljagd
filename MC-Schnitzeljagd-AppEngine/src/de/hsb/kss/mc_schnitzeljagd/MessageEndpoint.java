 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "hsb.de", ownerName = "hsb.de", packagePath="kss.mc_schnitzeljagd"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyARru4H5-gNsOx7waMvkAkraRT50hR6WxU";
