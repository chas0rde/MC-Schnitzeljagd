...
public class ReceiveTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (LocationClient.hasError(intent)) {
                ...
                // Log the error
                Log.e(LocationUtils.TAG, getString(R.string.geofence_transition_error_detail, errorMessage));
            ...
            if ((transition == Geofence.GEOFENCE_TRANSITION_ENTER)
                ...
                for (int index = 0; index < geofences.size(); index++) {
                        ...
                        notificationIds[index] = Long.parseLong(geofences.get(index).getRequestId());
                }
...
//                if ((transition == Geofence.GEOFENCE_TRANSITION_ENTER)) {
//                	NotificationHelper.notifyGeofence(getApplicationContext(), notificationIds);
//                }
//                else {
//                	NotificationHelper.unnotifyGeofence(getApplicationContext(), notificationIds);
//                }

                // Log the transition type and a message
                Log.d(LocationUtils.TAG,
                                getString(R.string.geofence_transition_notification_title, transitionType, ids));
                Log.d(LocationUtils.TAG, getString(R.string.geofence_transition_notification_text));
                ...
                Log.e(LocationUtils.TAG, getString(R.string.geofence_transition_invalid_type, transition));
            }
        }
    }
...
//        Intent notificationIntent = new Intent(getApplicationContext(), ActivityMain_.class);
